...
def export(trainer, model_path, onnx_path):
    ...
    print('testing...')
    trainer.test('g2p/id_id/test_log.txt')
...
if __name__ == '__main__':
    ...
    cfg = OmegaConf.load('g2p/id_id/cfg.yaml')

    # Loads the dataset.
    # Note that SphinxDataset may not work for your dictionary format.
    dataset = SphinxDataset('g2p/id_id/dict.txt', cfg,
                            comment_prefix=';;;',
                            # "RECORDS(1)" -> "RECORDS"
    ...
    export(trainer, 'g2p/id_id/g2p-best.ptsd', 'g2p/id_id/g2p.onnx')
